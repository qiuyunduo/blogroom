...
CREATE TABLE `admin`  (
  ...
  `status` int(1) NULL DEFAULT 0 COMMENT '状态，0为正常，1为锁定，2为注销',
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, 'admin@163.com', NULL, NULL, NULL, 0, NULL, '2019-02-27 14:31:35', NULL);
...
CREATE TABLE `friendly_link`  (
  ...
  `photo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '友情链接图片',
...
-- ----------------------------
INSERT INTO `friendly_link` VALUES (1, '#', '思衡网络', NULL, '2019-03-13 16:03:00', NULL);
INSERT INTO `friendly_link` VALUES (2, 'http://www.welcom212.com/wordpress/wp-login.php', '3DST技术网', NULL, '2019-02-27 14:28:31', NULL);
INSERT INTO `friendly_link` VALUES (3, 'github.com/qiuyunduo', 'qiuyunduo博主的github地址', NULL, '2019-02-27 14:29:00', NULL);
INSERT INTO `friendly_link` VALUES (4, 'https://blog.csdn.net/qydcsdn', 'qiuyunduo的csdn地址', NULL, '2019-02-27 14:29:48', NULL);
